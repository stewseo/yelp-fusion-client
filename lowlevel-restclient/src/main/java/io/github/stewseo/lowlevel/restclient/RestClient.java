...
public class RestClient implements Closeable, RestClientInterface {
    ...
    public static RestClientBuilder builder(String apiKey) {
        ...
        return new RestClientBuilder(apiKey);
    }

    public static RestClientBuilder builder(HttpHost host, HttpHost... hosts) {
        if (host == null) {
            ...
            client.execute(
                    ...
                    new FutureCallback<>() { // A callback interface that gets invoked upon completion of a java.util.concurrent.Future.
                        ...
                        public void failed(Exception failure) {
                            try {
                                RequestLogger.logFailedRequest(logger, request.httpRequest, context.httpHost, failure);
