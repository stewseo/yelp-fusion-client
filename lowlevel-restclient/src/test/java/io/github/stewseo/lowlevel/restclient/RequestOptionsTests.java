...
public class RequestOptionsTests extends RestClientTestCase {
    ...
    public void testDefault() {
        ...
        public void testAddHeader() {
            try {
                randomBuilder().addHeader(null, randomAsciiAlphanumOfLengthBetween(3, 10));
        ...
        private static RequestOptions mutate(RequestOptions options) {
            ...
            switch (mutationType) {
                ...
                default -> throw new UnsupportedOperationException("Unknown mutation type [" + mutationType + "]");
            }
        }
    }
