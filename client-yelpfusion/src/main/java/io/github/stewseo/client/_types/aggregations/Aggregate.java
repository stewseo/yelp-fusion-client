...
public class Aggregate implements OpenTaggedUnion<Aggregate.Kind, Object>, JsonpSerializable {
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code lrareterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code lterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code siglterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code sigsterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code simple_value} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code srareterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code sterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code umrareterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code umsigterms} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not of the {@code umterms} kind.
     */
    ...
    public static class Builder extends ObjectBuilderBase implements ObjectBuilder<Aggregate> {
         ...
         * @param data the data for this custom {@code Aggregate}. It is converted
