...
public class Region implements JsonpSerializable {
    ...
    static class Center implements JsonpSerializable {
        ...
        public static final JsonpDeserializer<Center> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Center.Builder::new,
                Center::setupCenterDeserializer);

        protected static void setupCenterDeserializer(ObjectDeserializer<Center.Builder> op) {
            op.add(Center.Builder::latitude, JsonpDeserializer.doubleDeserializer(), "latitude");
            op.add(Center.Builder::longitude, JsonpDeserializer.doubleDeserializer(), "longitude");
        }
    }
}