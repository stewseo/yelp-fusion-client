...
public class DoubleTermsAggregate extends TermsAggregateBase<DoubleTermsBucket> implements AggregateVariant {
	...
	public static class Builder extends AbstractBuilder<DoubleTermsBucket, Builder>
			implements
	...
	protected static void setupDoubleTermsAggregateDeserializer(ObjectDeserializer<Builder> op) {
