...
public class SearchBusinessResponse implements JsonpSerializable {
    ...
    public static class Builder extends WithJsonObjectBuilderBase<Builder>
        ...
        @Override
        protected SearchBusinessResponse.Builder self() {
            return this;
        }
    ...
    public static final JsonpDeserializer<SearchBusinessResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(SearchBusinessResponse.Builder::new,
