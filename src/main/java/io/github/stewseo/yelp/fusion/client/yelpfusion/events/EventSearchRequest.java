...
public class EventSearchRequest extends RequestBase implements JsonpSerializable {
    ...
    private EventSearchRequest(EventSearchRequest.Builder builder) {
        ...
        this.excluded_events = builder.excluded_events;
    ...
    public List<String> excluded_events() {
    ...
    public static EventSearchRequest of(Function<EventSearchRequest.Builder, ObjectBuilder<EventSearchRequest>> fn) {
        return fn.apply(new EventSearchRequest.Builder()).build();
    }
    ...
    public static class Builder extends RequestBase.AbstractBuilder<EventSearchRequest.Builder>
            implements
            ObjectBuilder<EventSearchRequest> {
        ...
        public final EventSearchRequest.Builder locale(String value) {
            this.locale = value;
            return this;
        }
        public final EventSearchRequest.Builder sort_by(String value) {
            this.sort_by = value;
            return this;
        }
        public final EventSearchRequest.Builder sort_on(String value) {
            this.sort_on = value;
            return this;
        }
        public final EventSearchRequest.Builder offset(Integer value) {
            this.offset = value;
            return this;
        }
        public final EventSearchRequest.Builder location(String value) {
            this.location = value;
            return this;
        }
        public final EventSearchRequest.Builder limit(Integer value) {
            this.limit = value;
            return this;
        }
        public final EventSearchRequest.Builder start_date(Integer value) {
            this.start_date = value;
            return this;
        }
        public final EventSearchRequest.Builder end_date(Integer value) {
            this.end_date = value;
            return this;
        }
        public final EventSearchRequest.Builder radius(Integer value) {
            this.radius = value;
            return this;
        }
        public final EventSearchRequest.Builder latitude(Double value) {
            this.latitude = value;
            return this;
        }
        public final EventSearchRequest.Builder longitude(Double value) {
            this.longitude = value;
            return this;
        }
        public final EventSearchRequest.Builder is_free(Boolean value) {
            this.is_free = value;
            return this;
        }
        public final EventSearchRequest.Builder excluded_events(List<String> values) {
            this.excluded_events = _listAddAll(this.excluded_events, values);
            return this;
        }
        public final EventSearchRequest.Builder excluded_events(String value, String values) {
            this.excluded_events = _listAdd(this.excluded_events, value, values);
            return this;
        }
        public final EventSearchRequest.Builder categories(List<String> values) {
            this.categories = _listAddAll(this.categories, values);
            return this;
        }
        public final EventSearchRequest.Builder categories(String value, String values) {
        ...
        @Override
        protected EventSearchRequest.Builder self() {
            return this;
        }

        public EventSearchRequest build() {
            _checkSingleUse();
            return new EventSearchRequest(this);
        }
    }

    public static final SimpleEndpoint<EventSearchRequest, ?> _ENDPOINT = new SimpleEndpoint<>("v3/events",
            ...
            }, SimpleEndpoint.emptyMap(), false, EventSearchResponse._DESERIALIZER);
}
