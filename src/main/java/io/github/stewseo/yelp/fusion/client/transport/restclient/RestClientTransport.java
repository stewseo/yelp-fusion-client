...
import io.github.stewseo.yelp.fusion.client.transport.endpoints.BooleanResponse;
...
public class RestClientTransport implements ElasticsearchTransport {
    ...
    public <RequestT, ResponseT, ErrorT> ResponseT performRequest(
        ...
        Response clientResp = restClient.performRequest(clientReq); // build the client Response
    ...
    private static final Set<String> endpointsMissingProductHeader = new HashSet<>(List.of(
