...
public class Review implements JsonpSerializable {
    ...
    // builder
    public static class Builder extends WithJsonObjectBuilderBase<Review.Builder>
    ...
    public static final JsonpDeserializer<Review> _DESERIALIZER =
            ObjectBuilderDeserializer.lazy(Review.Builder::new, Review::setupBusinessReviewDeserializer);

    protected static void setupBusinessReviewDeserializer(ObjectDeserializer<Builder> op) {
        op.add(Review.Builder::id, JsonpDeserializer.stringDeserializer(), "id");
