...
import static io.github.stewseo.yelp.fusion.client.json.JsonpDeserializer.booleanDeserializer;
...
//        }
    ...
    static class Open implements JsonpSerializable {
        ...
        protected static void setupOpenDeserializer(ObjectDeserializer<Builder> op) {
            op.add(Builder::is_overnight, booleanDeserializer(), "is_overnight");
            op.add(Builder::day, JsonpDeserializer.integerDeserializer(), "day");
            op.add(Builder::start, stringDeserializer(), "start");
            op.add(Builder::end, stringDeserializer(), "end");
        }
