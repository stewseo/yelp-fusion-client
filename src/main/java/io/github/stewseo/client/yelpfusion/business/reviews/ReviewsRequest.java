...
public class ReviewsRequest extends RequestBase implements JsonpSerializable {
    ...
    private ReviewsRequest(ReviewsRequest.Builder builder) {
        this.id = builder.id;
        this.alias = builder.alias;
    }

    public static ReviewsRequest of(Function<ReviewsRequest.Builder, ObjectBuilder<ReviewsRequest>> fn) {
        return fn.apply(new ReviewsRequest.Builder()).build();
    }
    ...
    public static class Builder extends RequestBase.AbstractBuilder<ReviewsRequest.Builder>
            implements
            ObjectBuilder<ReviewsRequest> {
        private String id;
        private String alias;

        public final ReviewsRequest.Builder id(String id) {
            this.id = id;
            return this;
        }

        public final ReviewsRequest.Builder alias(String alias) {
            this.alias = alias;
            return this;
        }
        @Override
        protected ReviewsRequest.Builder self() {
            return this;
        }
