...
public class Aggregation implements OpenTaggedUnion<Aggregation.Kind, Object>, JsonpSerializable {
    ...
    public static class Builder extends WithJsonObjectBuilderBase<Builder> {
        ...
        public Builder.ContainerBuilder dateHistogram(DateHistogramAggregation v) {
            this._kind = Kind.DateHistogram;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder dateHistogram(
        ...
        public Builder.ContainerBuilder dateRange(DateRangeAggregation v) {
            this._kind = Kind.DateRange;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder dateRange(
        ...
        public Builder.ContainerBuilder histogram(HistogramAggregation v) {
            this._kind = Kind.Histogram;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder histogram(
        ...
        public Builder.ContainerBuilder multiTerms(MultiTermsAggregation v) {
            this._kind = Kind.MultiTerms;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder multiTerms(
        ...
        public Builder.ContainerBuilder range(RangeAggregation v) {
            this._kind = Kind.Range;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder range(Function<RangeAggregation.Builder, ObjectBuilder<RangeAggregation>> fn) {
            return this.range(fn.apply(new RangeAggregation.Builder()).build());
        }

        public Builder.ContainerBuilder significantTerms(SignificantTermsAggregation v) {
            this._kind = Kind.SignificantTerms;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder significantTerms(
        ...
        public Builder.ContainerBuilder significantText(SignificantTextAggregation v) {
            this._kind = Kind.SignificantText;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder significantText(
        ...
        public Builder.ContainerBuilder terms(TermsAggregation v) {
            this._kind = Kind.Terms;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder terms(Function<TermsAggregation.Builder, ObjectBuilder<TermsAggregation>> fn) {
            return this.terms(fn.apply(new TermsAggregation.Builder()).build());
        }

        public Builder.ContainerBuilder weightedAvg(WeightedAverageAggregation v) {
            this._kind = Kind.WeightedAvg;
            this._value = v;
            return new Builder.ContainerBuilder();
        }

        public Builder.ContainerBuilder weightedAvg(
         ...
         */
        public Builder.ContainerBuilder _custom(String name, Object data) {
        ...
        public class ContainerBuilder implements ObjectBuilder<Aggregation> {
             ...
             * Adds all entries of <code>map</code> to <code>aggregations</code>.
             */
            public final Builder.ContainerBuilder aggregations(Map<String, Aggregation> map) {
             ...
             * Adds an entry to <code>aggregations</code>.
             */
            public final Builder.ContainerBuilder aggregations(String key, Aggregation value) {
             ...
             * Adds an entry to <code>aggregations</code> using a builder lambda.
             */
            public final Builder.ContainerBuilder aggregations(String key,
             ...
             * Adds all entries of <code>map</code> to <code>meta</code>.
             */
            public final Builder.ContainerBuilder meta(Map<String, JsonData> map) {
             ...
             * Adds an entry to <code>meta</code>.
             */
            public final Builder.ContainerBuilder meta(String key, JsonData value) {
