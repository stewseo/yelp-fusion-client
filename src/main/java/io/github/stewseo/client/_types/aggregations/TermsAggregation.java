...
import io.github.stewseo.client.yelpfusion.transform.PivotGroupBy;
import io.github.stewseo.client.yelpfusion.transform.PivotGroupByVariant;
...
public class TermsAggregation extends BucketAggregationBase implements AggregationVariant, PivotGroupByVariant {
	 ...
	 */
	@Override
	public io.github.stewseo.client._types.aggregations.Aggregation.Kind _aggregationKind() {
	 ...
	 */
	@Nullable
	public final io.github.stewseo.client._types.aggregations.TermsInclude include() {
		return this.include;
	}
	...
	public static class Builder extends AbstractBuilder<Builder>
		...
		@Nullable
		private io.github.stewseo.client._types.aggregations.TermsInclude include;
		 ...
		 * API name: {@code include}
		 */
		public final Builder include(@Nullable io.github.stewseo.client._types.aggregations.TermsInclude value) {
			this.include = value;
			return this;
		}
		 ...
		 * API name: {@code include}
		 */
		public final Builder include(Function<io.github.stewseo.client._types.aggregations.TermsInclude.Builder, ObjectBuilder<io.github.stewseo.client._types.aggregations.TermsInclude>> fn) {
			return this.include(fn.apply(new io.github.stewseo.client._types.aggregations.TermsInclude.Builder()).build());
		}
