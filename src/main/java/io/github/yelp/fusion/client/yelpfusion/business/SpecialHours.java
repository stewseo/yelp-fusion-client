...
public class SpecialHours implements JsonpSerializable {
    ...
    public static SpecialHours of(Function<SpecialHours.Builder, ObjectBuilder<SpecialHours>> fn) {
        return fn.apply(new SpecialHours.Builder()).build();
    }
    ...
    public static final JsonpDeserializer<SpecialHours> _DESERIALIZER = ObjectBuilderDeserializer.lazy(SpecialHours.Builder::new,
            SpecialHours::setUpSpecialHoursDeserializer);

    protected static void setUpSpecialHoursDeserializer(ObjectDeserializer<SpecialHours.Builder> op) {
        op.add(SpecialHours.Builder::is_closed, JsonpDeserializer.booleanDeserializer(), "is_closed");
        op.add(SpecialHours.Builder::is_overnight, JsonpDeserializer.booleanDeserializer(), "is_overnight");
        op.add(SpecialHours.Builder::start, JsonpDeserializer.stringDeserializer(), "start");
        op.add(SpecialHours.Builder::end, JsonpDeserializer.stringDeserializer(), "end");
        op.add(SpecialHours.Builder::date, JsonpDeserializer.stringDeserializer(), "date");
