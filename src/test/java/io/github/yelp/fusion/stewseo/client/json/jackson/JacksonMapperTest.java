package io.github.yelp.fusion.stewseo.client.json.jackson;
...
import io.github.yelp.fusion.stewseo.client.test_models.ModelTestCase;
...
public class JacksonMapperTest extends ModelTestCase {
    ...
    public static class TestData<TDocument> implements Serializable {
        ...
        protected static <TDocument> void setupTestDataDeserializer(ObjectDeserializer<Builder<TDocument>> op,
                                                                    JsonpDeserializer<TDocument> tDocumentDeserializer) {
