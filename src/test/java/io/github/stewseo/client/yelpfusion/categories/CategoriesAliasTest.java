...
import io.github.stewseo.client.yelpfusion.categories.GetCategoriesAliasResponse;
...
public class CategoriesAliasTest {
    ...
    void categoriesAliasTest() throws Exception {
        ...
        YelpFusionSyncBlockingClient client = YelpFusionSyncBlockingClient.createClient(System.getenv("YELP_API_KEY"));
