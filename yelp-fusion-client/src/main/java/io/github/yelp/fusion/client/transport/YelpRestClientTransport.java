...
public class YelpRestClientTransport implements YelpFusionTransport {
    ...
    public YelpRestClientTransport(YelpFusionRestClient restClient, JsonpMapper mapper, TransportOptions options) throws IOException { // TransportOptions
...
//                logger.debug(PrintUtils.red("EntityUtils.toString(entity)" + EntityUtils.toString(entity)));
