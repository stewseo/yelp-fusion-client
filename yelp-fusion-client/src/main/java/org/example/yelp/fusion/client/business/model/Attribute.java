...
import org.example.elasticsearch.client.util.ObjectBuilderBase;
...
public class Attribute implements JsonpSerializable {
    ...
    protected static void setupCategoriesDeserializer(ObjectDeserializer<Attribute.Builder> op) {
