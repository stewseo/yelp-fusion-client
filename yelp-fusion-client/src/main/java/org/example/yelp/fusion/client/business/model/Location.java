...
public class Location implements JsonpSerializable {
    ...
    protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
        ...
        if (this.county != null) {
            generator.writeKey("county");
            generator.write(this.county);
        }
        if (this.country != null) {
            generator.writeKey("country");
            generator.write(this.country);
        }
        if (this.cross_streets != null) {
            generator.writeKey("cross_streets");
            generator.write(this.cross_streets);
        }
    }
    ...
    protected static void setupLocationDeserializer(ObjectDeserializer<Location.Builder> op) {
