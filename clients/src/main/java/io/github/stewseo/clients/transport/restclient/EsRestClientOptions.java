...
import io.github.stewseo.clients.transport.Version;
import io.github.stewseo.clients.util.VisibleForTesting;
...
public class EsRestClientOptions implements TransportOptions {
    ...
    public static class Builder implements TransportOptions.Builder {
        ...
        @Override
        public EsRestClientOptions build() {
            return new EsRestClientOptions(addBuiltinHeaders(builder).build());
        }
    }
}
