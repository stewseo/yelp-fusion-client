...
public class EventSearchResponse extends RequestBase implements JsonpSerializable {
    ...
    public static EventSearchResponse of(Function<Builder, ObjectBuilder<EventSearchResponse>> fn) {
    ...
    public static final JsonpDeserializer<EventSearchResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
