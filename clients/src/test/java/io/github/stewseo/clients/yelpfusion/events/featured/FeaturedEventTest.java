package io.github.stewseo.clients.yelpfusion.events.featured;//package io.github.stewseo.clients.yelpfusion.events.featured;
//
...
//        try {
//
//            FeaturedEventResponse response = yelpFusionService.yelpFusionAsyncClient().events().featured(f -> f
//                            .latitude(lat)
//                            .longitude(lon))
//                    .get();
//
