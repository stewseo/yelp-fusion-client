...
@JsonpDeserializable
public class TestCategory implements JsonpSerializable {

    public static final JsonpDeserializer<TestCategory> _DESERIALIZER =
            ObjectBuilderDeserializer.lazy(Builder::new,
                    TestCategory::setupCategoriesDeserializer);
    ...
    private TestCategory(Builder builder) {
    ...
    public static TestCategory of(Function<Builder, ObjectBuilder<TestCategory>> fn) {
    ...
    public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<TestCategory> {
