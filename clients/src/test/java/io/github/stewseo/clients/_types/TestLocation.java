...
@JsonpDeserializable
public class TestLocation implements JsonpSerializable {
    ...
    public static TestLocation of(Function<Builder, ObjectBuilder<TestLocation>> fn) {
    ...
    public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<TestLocation> {
    ...
    public static final JsonpDeserializer<TestLocation> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
            TestLocation::setupLocationDeserializer);
