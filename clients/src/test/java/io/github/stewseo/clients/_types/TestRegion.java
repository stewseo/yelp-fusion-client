...
@JsonpDeserializable
public class TestRegion implements JsonpSerializable {

    private final Center center;

    private TestRegion(Builder builder) {
        this.center = builder.center;
    }

    public static TestRegion of(Function<Builder, ObjectBuilder<TestRegion>> fn) {
    ...
    public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<TestRegion> {
        ...
        public TestRegion build() {
            _checkSingleUse();

            return new TestRegion(this);
        }
    }
