...
public class TestHours implements JsonpSerializable {
    ...
    public static class Builder extends WithJsonObjectBuilderBase<Builder> implements ObjectBuilder<TestHours> {
...
//        }
        ...
        public TestHours build() {
            _checkSingleUse();
            return new TestHours(this);
        }
    }
    ...
    public static final JsonpDeserializer<TestHours> _DESERIALIZER = ObjectBuilderDeserializer.lazy(Builder::new,
            TestHours::setupHoursDeserializer);
